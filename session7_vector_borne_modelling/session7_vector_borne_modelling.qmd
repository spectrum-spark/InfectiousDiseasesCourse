...
[$\mathcal{R}_{MH} \times \mathcal{R}_{HM}$ is $\mathcal{R}_0$ for vector borne models]{style="color: blue"}<br>
...
[$\mathcal{R}_0$ decreases, because the fixed number of bites from a mosquito are now spread over a larger population,
...
[$\mathcal{R}_0$ decreases because mosquitoes have a shorter amount of time over which they are able to bite humans.]{style="color: blue"}
