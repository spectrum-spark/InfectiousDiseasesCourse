...
Unlike diseases that spread directly from person to person, vector-borne diseases are those diseases in which the spread of an infectious pathogen occurs via a vector &mdash; a living organism such as a mosquito. Examples of vectors include (left to right) mosquitoes, ticks, blackflies and fleas: 
...
### Human and mosquito populations interact through <span style="color: red">bites</span>
...
### Births and deaths
* Typically the demographic processes of mosquitoes (births, deaths) occur on a much shorter time scale than the same processes for humans &mdash; mosquitoes may live a few weeks whereas humans live for decades.
