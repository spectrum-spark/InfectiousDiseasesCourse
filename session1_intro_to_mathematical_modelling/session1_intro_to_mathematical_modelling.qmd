...
presenter: '<a href="https://research.jcu.edu.au/portfolio/roslyn.hickson/">Roslyn Hickson</a>'
contributors:
  ...
  - 'Adapted and previously presented by <a href="https://research.jcu.edu.au/portfolio/emma.mcbryde">Emma McBryde</a>, Australian Institute of Tropical Health & Medicine, James Cook University'
  - 'Adapted by the presenter, <a href="https://research.jcu.edu.au/portfolio/roslyn.hickson/">Roslyn Hickson</a>, College of Public Health, Medical and Veterinary Sciences and Australian Institute of Tropical Health & Medicine, James Cook University, and CSIRO'
execute:
  echo: false
  warning: false
---
...
Here is some code to record and plot your results in R. Work in your course RStudio Project and [download the Session 1 starter script](../session1_introduction_beans.R){download="session1_introduction_beans.R"}. Save it with your course files, open it in RStudio and replace the default results with your own.

```{r bean-plot, echo=TRUE, eval=TRUE}
...
```{r plot-beans, echo=TRUE, eval=TRUE}
#| warning: false
library(ggplot2)
...
[Download the code for this session so far](../session1_introduction_beans_complete.R){download="session1_introduction_beans_complete.R"}. This runnable script includes the completed population check and plot.
:::
