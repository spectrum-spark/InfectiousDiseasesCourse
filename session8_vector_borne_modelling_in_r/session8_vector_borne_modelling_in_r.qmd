...
session. Open R studio, and then open the file `session8.R` in the
`\student_materials` folder. Copy and paste the code chunk below (or
...
```{r part_1_solutions, ECHO=T, eval=F}
#############################################################
## MODELLING VECTOR-BORNE DISEASES PRACTICAL SESSION PART 1##
#############################################################
