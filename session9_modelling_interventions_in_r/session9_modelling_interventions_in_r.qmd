...
Now we have a model for the COVID-19 transmission in Thailand, and we have estimates of how effective the tw os tages of interventions were (emergency and curfew), we can now explore what *could* have happened, or the **counterfactuals**.
...
Which of the scenarios you suggested previously might be of interested to the general public and why? Woudl the scenarios of interest to decision makers be different? If so, how and why?
<textarea name='Text1' cols='127' rows='2'></textarea>