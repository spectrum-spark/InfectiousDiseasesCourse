...
COVID.intervention <- function(t, state, parameters) {
    with(as.list(c(state, parameters)), {
        ...
        # Calculate the new reproduction number in the presence of interventions
...
# Counterfactuals example solution

::: {.panel-tabset}

## Spoiler alert

The solutions tab contains the complete code for the counterfactuals. **Only click on it if
you have tried to complete the exercises yourself and need some help**

## Solutions for Exploring counterfactuals

Your code to explore the counterfactuals might look like this:

```{r counter_factual_eg_solutions, echo=TRUE, eval=FALSE}
