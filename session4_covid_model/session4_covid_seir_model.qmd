...
format:
    training-html:
        presenter: Dewi Anastasia Christina, Eijkman Molecular Biology Research Group/School of Public Health, The National Research and Innovation Agency (BRIN)/Imperial College London
        contributors:
...
<img src="new_R_project1.png" style="width:80%"/>
:::
::::
...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="new_R_project2.png" style="width:40%;"/>
  <img src="new_R_project3.png" style="width:40%;"/>
</div>
::::
...
<img src="new_R_project4.png" style="width:40%"/>
:::
::::
...
<img src="new_R_project5.png" style="width:60%"/>
:::
::::
<p>
...
:::: {#fig-project .text-center}
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="new_R_project_data_management1.png" style="width:40%;"/>
  <img src="new_R_project_data_management2.png" style="width:40%;"/>
</div>
::::
...
```{r load-data}
# Data imports
first_wave <- read.csv("data/first_wave_COVID.csv", colClasses = c("Date", "numeric", "numeric"))
# Convert dates
