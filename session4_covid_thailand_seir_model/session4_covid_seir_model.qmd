...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="new_R_project2.png" style="width:38%;"/>
  <img src="new_R_project3.png" style="width:38%;"/>
</div>
::::
...
<img src="new_R_project4.png" style="width:80%"/>
:::
::::

:::: row
::: {style="text-align:center"}
4. RStudio will open the new project in its own session, with the working directory automatically set to the folder you specified.
<img src="new_R_project5.png" style="width:80%"/>
:::
::::

At this stage, it is best to organize your work by creating a separate R script for each workshop session.
