...
1.  <div>
    ...
    ![Open **RStudio**, navigate to **File**, then choose **New Project.**](new_R_project1.png)
...
::::::::::: row
:::::: {#fig-project .figure .text-center}
::::: row
::: col
...
3.  <div>
    ...
    ![Write the name and set the storage of the project](new_R_project4.png)
