---
title: "Modelling an outbreak - COVID-19 in Thailand" # Fitting models in R
author:
...
<!-- fixme: we may not want to do this as it caused issues in the past, if so remove from ToC-->
## Set working directory
