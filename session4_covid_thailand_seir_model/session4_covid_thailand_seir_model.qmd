...
ggplot(first_wave) +
  ...
  geom_line(data=tidied_output, aes(x=Date, y=Incidence), size=1, colour="firebrick") +
  ylab("Daily cases") +
  xlab("") +
...
ggplot(first_wave) +
  geom_point(aes(x=Date, y=Cumulative_cases), linewidth=2, colour="skyblue") +
  geom_line(data=tidied_output, aes(x=Date, y=Cumulative_incidence), size=1, colour="firebrick") +
