...
* [Download the SEIRS Shiny app](../shiny_app_SEIRS_variations.R){download="shiny_app_SEIRS_variations.R"} and save it with your course files.
* Open it in RStudio and click **Run App**.
